...
const servizi = [
  {
    ...
    description:
      "Analizziamo la tua situazione attuale e definiamo un piano d'azione concreto per raggiungere i tuoi obiettivi di business.",
    icon: (
      <path
        strokeLinecap="round"
  ...
  },
  {
    ...
    description:
      "Realizziamo siti web, applicazioni e strumenti digitali su misura, con un focus su performance, usabilità e crescita.",
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  },
  {
    ...
    description:
      "Costruiamo la tua presenza online e definiamo strategie di comunicazione efficaci per raggiungere il pubblico giusto.",
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
  ...
  },
  {
    ...
    description:
      "Non ti lasciamo solo dopo il lancio: monitoriamo i risultati e ottimizziamo costantemente per garantirti crescita nel tempo.",
    icon: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
